        ...
        <section className="bg-[#f8fafc] py-20 px-6 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute -top-10 -left-10 w-64 h-64 bg-emerald-200 rounded-full blur-[100px] opacity-50 group-hover:opacity-80 transition-opacity duration-700 pointer-events-none"></div>
                    <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-emerald-100 rounded-full blur-[100px] opacity-50 group-hover:opacity-80 transition-opacity duration-700 pointer-events-none"></div>

                    {/* The Premium Card */}
                    <div className="relative z-10 bg-slate-900 rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl shadow-emerald-900/20">

                        {/* Decorative Wave/Slant Element (Fixed with pointer-events-none) */}
                        <div className="absolute top-0 right-0 w-1/2 h-full bg-emerald-600/10 skew-x-[-15deg] transform origin-top translate-x-20 hidden lg:block pointer-events-none"></div>

                        {/* Content Container (Fixed with relative z-10) */}
                        <div className="relative z-10 flex flex-col lg:flex-row items-center p-8 md:p-16 lg:p-20 gap-10 lg:gap-16">
                            ...
                            <div className="flex-shrink-0 w-full lg:w-auto">
                                <button
                                    className="w-full lg:w-auto group/btn flex items-center justify-center gap-4 bg-emerald-500 hover:bg-white text-slate-900 px-10 py-6 rounded-3xl font-black text-sm uppercase tracking-widest transition-all duration-500 shadow-xl shadow-emerald-500/20 active:scale-95"
