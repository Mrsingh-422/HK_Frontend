...
import {
    ...
    FaPhoneAlt, FaHospital, FaTimes, FaArrowRight
} from "react-icons/fa";
...
const STATIC_PAGE_DATA = {
    ...
    description: "Locate the best medical facilities near you. We provide verified information about hospitals, including distance, patient ratings, and direct booking services.",
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 h-fit">
                    <div className="border-l-4 border-[#08B36A] pl-5 md:pl-6 space-y-3 md:space-y-4">
                        ...
                        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-slate-900 leading-tight whitespace-pre-line">
                            {pageData.mainTitle}
                        </h1>
                    ...
                    <div className="space-y-4 max-w-md">
                        <label className="text-[#08B36A] font-black text-[11px] uppercase tracking-[0.2em]">
