...
export default function HospitalChangePasswordPage() {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const res = await HospitalAPI.changePassword({
      ...
      if (responseMessage.includes("bcrypt is not defined")) {
        alert("Server Error: Missing password hashing configuration on backend.")
      } else {
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6 pb-12 px-4 md:px-0">
      ...
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl font-extrabold text-gray-800 tracking-tight uppercase leading-none">Security Center</h1>
        <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-3">Ensure your operational credentials are secure</p>
      </div>
      ...
      <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-sm border border-gray-100">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-xl font-extrabold text-gray-800 uppercase tracking-tight">Change Password</h2>
        </div>
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              <input 
                ...
                placeholder="••••••••" 
                className="w-full px-4 py-3.5 rounded-2xl border border-gray-200 focus:ring-4 focus:ring-[#08B36A]/10 focus:border-[#08B36A] outline-none font-medium text-gray-800 pr-12 text-sm"
                required 
              />
              <button
                type="button"
          ...
          <div className="pt-4">
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 py-4 bg-[#08B36A] hover:bg-emerald-600 text-white font-bold rounded-2xl active:scale-95 transition-all text-xs uppercase tracking-wider disabled:opacity-50"
            >
