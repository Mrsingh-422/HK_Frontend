...
import { FaTimes, FaProcedures, FaCheckCircle, FaDollarSign, FaNotesMedical, FaClock } from 'react-icons/fa';
...
const BedAllocationModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
      <div className="bg-white rounded-[2.5rem] w-full max-w-xl shadow-2xl p-6 md:p-8 border border-slate-100 flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="flex justify-between items-center mb-6 shrink-0 border-b border-slate-50 pb-4">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-bold uppercase mt-0.5">Step 2: Choose Room & Ward</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
        ...
        {/* Wards Horizontal List - Pill Tabs */}
        ...
        <div className="flex-grow overflow-y-auto min-h-0 py-1 pr-1">
          {loadingBeds ? (
            ...
            <div className="grid grid-cols-3 gap-3.5">
              {beds.map(bed => {
                ...
                return (
                  ...
                  >
                    {/* Upper Card: Number & Ventilator Badge */}
                    <div>
            ...
            <div className="h-full flex flex-col items-center justify-center py-12 text-slate-400">
              <FaNotesMedical size={20} className="text-slate-300 mb-2" />
