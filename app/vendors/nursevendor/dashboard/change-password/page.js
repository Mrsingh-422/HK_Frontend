...
export default function NurseChangePasswordPage() {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const res = await NurseAPI.changePassword({
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6 pb-12 px-4 md:px-0">
      ...
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl font-extrabold text-[#1e3a8a] tracking-tight uppercase leading-none">Nurse Security Center</h1>
        <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-3">Configure and secure your clinical service credentials</p>
      </div>
