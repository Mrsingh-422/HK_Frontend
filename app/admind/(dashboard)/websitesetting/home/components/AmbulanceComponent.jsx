...
function AmbulanceComponent() {
    const { saveAmbulanceContent } = useAdminContext();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await saveAmbulanceContent(data);

            if (response?.success) {
                setSuccess("Introduction section saved successfully!");

                // Refetch updated content
                const updated = await getAmbulanceContent();
