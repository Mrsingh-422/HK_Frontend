...
import HospitalFacilityAdmin from "./components/HospitalFacilityAdmin";
import MainHowItWorksAdmin from "./components/MainHowItWorksAdmin";
import HospitalPageAdmin from "./components/HospitalPageAdmin";

function Page() {
    const [activeTab, setActiveTab] = useState("hospitalpage");

    const tabs = [
        { id: "hospitalpage", label: "Hospital Page" },
        { id: "hospitalfacility", label: "Hospital Facility" },
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            case "hospitalpage":
                return <HospitalPageAdmin />;
            case "hospitalfacility":
                return <HospitalFacilityAdmin />;
            case "howitworks":
                return <MainHowItWorksAdmin />;
            default:
                return null;
        }
    };
