...
function AboutMedicineAdmin() {
    const { saveAboutMedicineContent } = useAdminContext();
    ...
    const fetchAboutMedicine = async () => {
        try {
            ...
            if (res?.success && res?.data) {
                ...
                // Standardizing image URLs logic
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await saveAboutMedicineContent(data);

            setSuccess(
                hasData
                    ? "About Medicine section updated successfully!"
                    : "About Medicine section added successfully!"
            );
                ...
                <div className="bg-white w-full max-w-5xl rounded-2xl shadow-lg p-8">
                    ...
                    >
                        ...
                        <div className="md:col-span-2 space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {formData.skills.map((skill, idx) => (
                                    <div key={idx} className="flex flex-wrap md:flex-nowrap gap-4 items-center bg-gray-50 p-4 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-600 mb-2">Lab Carousel Images</label>
                            <input
                                type="file"
                                multiple
                                accept="image/*"
...
export default AboutMedicineAdmin;