  ...
  const filteredData = useMemo(() => {
    return data.filter(
      (item) =>
        ...
        item.insuranceNo.toLowerCase().includes(search.toLowerCase())
    );
  }, [search]);
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100 text-gray-700 text-left">
                ...
                <th className="p-3 font-semibold">Insurance No</th>
              ...
              {paginatedData.length === 0 ? (
                ...
                paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="p-3">{item.insuranceNo}</td>
                    ...
                    <td className="p-3">
                      <button className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded-md text-sm flex items-center gap-1">
                        <FaEye />
                        View
                      </button>
                    </td>
